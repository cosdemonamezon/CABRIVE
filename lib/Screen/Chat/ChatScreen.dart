          ...
          bottom: TabBar(
            ...
            tabs: [
              ...
              Tab(
                child: Align(
                  alignment: Alignment.center,
                  child: Text("Member", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold,)),
                ),
              ),
        ...
        body: TabBarView(
          ...
          ListView(
            children: [
              ...
              _cardMember("assets/images/captain-america.jpg", "Captain America"),
            ],
          ),
          ...
          child: Row(
            children: [
              ...
              children: <Widget>[
                Text(
                  name,
                  style: TextStyle(color: kFontPrimaryColor, fontSize: 18, fontWeight: FontWeight.bold),
                ),
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: Icon(Icons.search, color: kFontPrimaryColor,),
        ),
      ),
    );
  }
